...
describe("ScrollAnimation", () => {
  ...
  describe("StaggerAnimation Component", () => {
    it("should render multiple children with stagger effect", () => {
      const children = [
        <div key="1" data-testid="stagger-1">
          Item 1
        </div>,
        <div key="2" data-testid="stagger-2">
          Item 2
        </div>,
        <div key="3" data-testid="stagger-3">
          Item 3
        </div>,
      ];

      render(<StaggerAnimation>{children}</StaggerAnimation>);
    ...
    it("should apply custom className to container", () => {
      const children = [
        <div key="1" data-testid="stagger-custom-1">
          Item 1
        </div>,
      ];
    ...
    it("should handle empty children array", () => {
      const { container } = render(<StaggerAnimation>{[]}</StaggerAnimation>);

      const firstElement = container.firstElementChild as HTMLElement | null;
      expect(firstElement).not.toBeNull();
      expect(firstElement?.children).toHaveLength(0);
    });
  });
  ...
  describe("Error Handling", () => {
    it("should handle missing children gracefully", () => {
      const { container } = render(<ScrollAnimation>{null}</ScrollAnimation>);
