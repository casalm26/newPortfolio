...
describe("About Page", () => {
  describe("Page Rendering", () => {
    ...
    it("should render terminal command prompt", () => {
      ...
      expect(
        screen.getByText("caspian@localhost:~$ cat about.txt"),
      ).toBeInTheDocument();
    });
    ...
    it("should render bio section", () => {
      ...
      expect(
        screen.getByText(/I'm a full-stack developer with a passion/),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Philosophy Section", () => {
    it("should render development philosophy", () => {
      ...
      expect(
        screen.getByText(/Clean, maintainable code is more valuable/),
      ).toBeInTheDocument();
      expect(
        screen.getByText(/Performance matters, but premature optimization/),
      ).toBeInTheDocument();
    });
    ...
    it("should render all philosophy points", () => {
      ...
      expect(
        screen.getByText("User experience should drive technical decisions"),
      ).toBeInTheDocument();
      expect(
        screen.getByText(
  ...
  describe("Status Section", () => {
    it("should render current status information", () => {
      ...
      expect(
        screen.getByText("AVAILABLE_FOR_OPPORTUNITIES"),
      ).toBeInTheDocument();
