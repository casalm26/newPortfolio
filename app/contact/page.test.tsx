...
describe('Contact Page', () => {
  describe('Page Rendering', () => {
    it('should render contact form and information', () => {
      ...
      expect(screen.getByText('Initialize communication protocol. Ready to receive your transmission.')).toBeInTheDocument();
    ...
    it('should render terminal-style command prompts', () => {
      ...
      expect(screen.getByText('caspian@localhost:~$ ./contact.sh')).toBeInTheDocument();
      expect(screen.getByText('> echo "message" > /dev/contact')).toBeInTheDocument();
    ...
    it('should render social links', () => {
      ...
      expect(screen.getByRole('link', { name: /github.com\/caspian/i })).toBeInTheDocument();
      expect(screen.getByRole('link', { name: /linkedin.com\/in\/caspian/i })).toBeInTheDocument();
      expect(screen.getByRole('link', { name: /twitter.com\/caspian/i })).toBeInTheDocument();
    });
  });
  ...
  describe('Social Links', () => {
    it('should have proper external link attributes', () => {
      ...
      const githubLink = screen.getByRole('link', { name: /github.com\/caspian/i });
      const linkedinLink = screen.getByRole('link', { name: /linkedin.com\/in\/caspian/i });
  ...
  describe('Terminal Styling', () => {
    ...
    it('should have terminal color scheme', () => {
      ...
      const commandPrompt = screen.getByText('caspian@localhost:~$ ./contact.sh');
