...
describe('Projects Page', () => {
  describe('Page Rendering', () => {
    it('should render page title and terminal prompt', () => {
      ...
      expect(screen.getByText('caspian@localhost:~$ ls projects/')).toBeInTheDocument();
      expect(screen.getByText('Digital artifacts and code experiments from the development journey.')).toBeInTheDocument();
    });
  ...
  describe('Terminal Styling', () => {
    ...
    it('should have terminal command styling', () => {
      ...
      const commandPrompt = screen.getByText('caspian@localhost:~$ ls projects/');
  ...
  describe('Responsive Design', () => {
    ...
    it('should have responsive grid layout', () => {
      ...
      const projectsContainer = screen.getByText('Test Project 1').closest('div')?.parentElement?.parentElement;
