...
date: '2023-11-20'
lastmod: '2023-12-30'
tags: ['Data Visualization', 'D3.js', 'Python', 'Analytics', 'Environmental Data']
draft: false
...
skills: ['Python', 'D3.js', 'React', 'Pandas', 'Machine Learning', 'Data Analysis', 'Visualization Design']
tools: ['Python', 'Jupyter', 'D3.js', 'React', 'FastAPI', 'PostgreSQL', 'Docker', 'Vercel']
links:
